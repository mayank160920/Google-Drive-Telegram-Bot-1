...
@Client.on_message(filters.text & filters.command(BotCommands.Download)) | filters.regex('^(ht|f)tp*'))
...
@Client.on_message(filters.incoming & (filters.document | filters.audio | filters.video))
